...
const LAUNDRY_DEVICES = [
  { id: "unit-001", name: "UNIT_001", deviceId: process.env.SWITCHBOT_DEVICE_002 || "", currentThreshold: 5000 },
  { id: "unit-002", name: "UNIT_002", deviceId: process.env.SWITCHBOT_DEVICE_001 || "", currentThreshold: 5000 },
